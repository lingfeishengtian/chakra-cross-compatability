...
export function setV2CreateToaster(createToaster: (ToastOptions: ToastOptions<string>) => void) {
    v2CreateToaster = createToaster;
}

export function setV3CreateToaster(createToaster: (ToastOptions: ToastOptions<string>) => void) {
