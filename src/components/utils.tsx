...
export function createCompatibleComponent<PropType extends Record<string, any>>(
    ...
    extraTranslationHandler: (props: Record<string, any>) => Record<string, any> = (props) => props
) {
    const Compat = forwardRef<any, PropType>((props, ref) => {
        // Translate props based on the provided entries
        const finalProps = chakraVersion === '2' ? extraTranslationHandler(translateProps(props, entries)) : props;
